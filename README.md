...
| **5** | **LangGraph orchestration** | Wire all agents into the stateful graph; conditional auth gate; Redis queue + async workers; checkpointing | One command runs the full recon workflow end-to-end |
